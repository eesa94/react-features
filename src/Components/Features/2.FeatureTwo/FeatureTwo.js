					...
					<div className="row">
						<div className="col-10-offset-1">
							...
							<p className="changa2 white howItWorksText">
								...
								transparent to opaque background, size of text, or width of the
								nav bar.
							</p>
							<p className="changa2 white howItWorksText">
								Requires a function to detect scroll position which can then be
								used to style components dynamically.
							</p>
						</div>
					</div>
				</div>
